...
*/
    ...
    public static class FileUploadExceptionAdvice {
        ...
        public ResponseEntity<RestData<?>> handleMaxSizeException(MaxUploadSizeExceededException exc) {
            String errMessage = "File quá lớn!";
            return VsResponseUtil.error(HttpStatus.BAD_REQUEST,errMessage);
        }
    }
}
