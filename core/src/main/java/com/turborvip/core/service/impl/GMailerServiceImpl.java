...
public class GMailerServiceImpl implements GMailerService {
    ...
    public Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory) throws IOException {
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory, new InputStreamReader(Objects.requireNonNull(GMailerServiceImpl.class.getResourceAsStream("/tokensAccess/client_secret_302252990150-3sdef222mvo6t2h6p6hnojmkas1767vk.apps.googleusercontent.com.json"))));
